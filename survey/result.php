...
<body>
    ...
    <table width=250 height=250 border='0' cellspacing='0' cellpadding='0'>
        ...
        <tr>
          ...
          <td></td>
          <td valign=middle><b>☯ 가장 좋아하는 게임은? ☯</b></td>
          <td></td>
        ...
        <tr>
          ...
          <td></td>
          <td> 리그오브레전드 (<b><? echo $ans1_percent ?></b> %)
...
?>
        ...
        <tr>
          <td height=20 bgcolor='#ffffff'></td>
          <td></td>
          <td> 배틀그라운드 (<b><? echo $ans2_percent ?></b> %)
