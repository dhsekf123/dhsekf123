...
<head> 
<meta charset="utf-8">
<link href="../css/common.css" rel="stylesheet" type="text/css" media="all">             //link href 연결할곳의 주소 rel 현재문서와의 연결 관계 표시stylesheet 스타일시트로 연결할때  media 연결문서가 표시될 장치 또는 미디어 유형all모든 장치에 알맞느 기본값
<link href="../css/member.css" rel="stylesheet" type="text/css" media="all">
<script>
   function check_id()                         //함수 check_id 
   {
